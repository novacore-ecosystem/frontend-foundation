...
export const ERROR_DEFINITIONS: readonly ErrorDefinition[] = [
  ...
  { code: MessageCode.EmailResendCooldown, messageKey: "errors.auth.emailResendCooldown", defaultMessage: "Please wait before requesting another email" },
  { code: MessageCode.VerificationCodeLocked, messageKey: "errors.auth.verificationCodeLocked", defaultMessage: "Too many invalid attempts. Please try again later" },
  ...
  { code: MessageCode.InvalidToken, messageKey: "errors.auth.invalidToken", defaultMessage: "Your session is no longer valid. Please log in again." },
  { code: MessageCode.InsufficientPermissions, messageKey: "errors.auth.insufficientPermissions", defaultMessage: "You don't have permission to perform this action" },
  ...
  { code: MessageCode.AccountLocked, messageKey: "errors.auth.accountLocked", defaultMessage: "This account has been locked. Please contact support." },
  { code: MessageCode.AccountDisabled, messageKey: "errors.auth.accountDisabled", defaultMessage: "This account has been disabled." },
  ...
  { code: MessageCode.EmailNotVerified, messageKey: "errors.auth.emailNotVerified", defaultMessage: "Please confirm your email before logging in." },
